<div class="row">
	<div class="col-xs-12 col-sm-6" id="EditForm">
			...
			<div class="form-horizontal" style="padding: 10px;">
				...
				<form method="POST" id="assetsForm" action="#">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="assetsname"> Assets Name: </label>
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="supplier_name"> Supplier Name: </label>
						<div class="col-xs-8 col-sm-8">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="rate"> Rate: </label>
						<div class="col-xs-8 col-sm-8">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="qty"> Quantity: </label>
						<div class="col-xs-8 col-sm-8">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="amount"> Amount: </label>
						<div class="col-xs-8 col-sm-8">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="note"> Note: </label>
						<div class="col-xs-8 col-sm-8">
	...
	<div class="col-xs-12 col-sm-6" id="EditForm1">
		<div class="panel panel-default">
			...
			<div class="form-horizontal" style="padding: 10px;">
				...
				<form method="POST" id="assetsSaleForm" action="#">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="customer_name"> Customer Name: </label>
						<div class="col-xs-8 col-sm-8">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="unit_valuation"> Valuation: </label>
						...
						<label class="col-xs-4 col-sm-2 control-label no-padding-right" for="valuation"> Total: </label>
						<div class="col-xs-8 col-sm-3">
					...
					<div class="form-group">
						<label class="col-xs-4 col-sm-3 control-label no-padding-right" for="rate"> S. Rate: </label>
						<div class="col-xs-8 col-sm-3">
							<input type="number" id="s_rate" required name="rate" placeholder="Rate" class="form-control" onblur="TotalSaleAmount()"/>
							<span id="error"></span>
						</div>
						<label class="col-xs-4 col-sm-2 control-label no-padding-right" for="qty"> Qty: </label>
						<div class="col-xs-8 col-sm-3">
