			...
			<div class="table-responsive" id="reportTable">
				<table id="table1">
					...
					<tfoot style="font-weight:bold;background-color:#e9dcdc;">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Premium Income (+)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ otherIncomeExpense.withdraw_commission | decimal }}</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"></td>
							<td style="text-align:right;">
								{{  ((parseFloat(totalProfit) + parseFloat(totalVat) + parseFloat(otherIncome) + parseFloat(otherIncomeExpense.withdraw_commission)) - 
