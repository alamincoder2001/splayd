        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="commission_withdraw" v-model="access"> Commission Withdraw</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="color" v-model="access"> Add Color</li>
                    <li><input type="checkbox" class="access" value="size" v-model="access"> Add Size</li>
