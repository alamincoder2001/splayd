...
<body class="skin-2">
	<div id="navbar" class="navbar navbar-default ace-save-state navbar-fixed-top" style="background:#3e2e6b !important;">
		<div class="navbar-container ace-save-state" id="navbar-container" style="display:flex;;align-items:center;">
			...
			<div class="navbar-header pull-left navbar-header-first">
				<a href="<?php echo base_url(); ?>" class="navbar-brand">
					<small>
						<i class="fa fa-shopping-cart"></i>
						<?php echo $companyInfo->Company_Name; ?> <span style="color:#000;font-weight:700;letter-spacing:1px;font-size:16px;"> <?php //echo $this->session->userdata('Brunch_name'); 
																																				?> </span>
					</small>
				</a>
			</div>
			<div style="display: flex;margin-left:0;">
				<div class="extra-menu-part" style="position:relative;margin-left:5px">
					...
					<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>order_entry">Order Sales Entry</a>
						</li>
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>pending_order">Pending Order Sales</a>
						</li>
						<li>
							<a class="top-a-btn" href="<?php echo base_url(); ?>processing_order">Processing Order Sales</a>
						</li>
						<li>
			...
			<div class="navbar-buttons navbar-header pull-right" role="navigation" style="margin-left:auto">
