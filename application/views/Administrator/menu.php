	...
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/OrderModule">
				...
				<span class="menu-text"> Order Sales Module </span>
			</a>
			<b class="arrow"></b>
		</li>
		...
		<?php if (array_search("order_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>order_entry">
					<i class="menu-icon fa fa-shopping-cart"></i>
					<span class="menu-text"> Order Sales Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("orderrecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>orderrecord">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Order Sales Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
