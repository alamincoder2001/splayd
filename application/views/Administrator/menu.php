...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("commission_withdraw", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>commission_withdraw">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Commi. Withdraw </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
