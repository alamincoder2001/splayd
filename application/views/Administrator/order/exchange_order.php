    ...
    <div class="col-xs-12 col-md-9 col-lg-9">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">Exchange Product Information</h4>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12" style="padding-left: 0px;padding-right: 0px;">
            <div class="table-responsive text-center">
                <caption>Old Order/Sales Product</caption>
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    <thead>
                        <tr class="">
                            <th style="width:7%;color:#000;">Sl</th>
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart1.length > 0 ? '' : 'none'}">
                        <tr v-for="(product, sl) in cart1">
                            <td>{{ sl + 1 }}</td>
                            <td>{{ product.productCode }}</td>
                            <td>{{ product.name }}</td>
                            <td>{{ product.categoryName }}</td>
                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Previous SubTotal</label>
                                                <div class="col-xs-12">
                                                    <input type="number" id="previousSubTotal" class="form-control" v-model="sales.previousSubTotal" readonly />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        methods: {
            ...
            calculateTotal() {
                ...
                this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this.sales.vat) + parseFloat(this
                    .sales.transportCost)) - parseFloat(this.sales.discount)).toFixed(2) - this.sales.previousSubTotal;
            ...
            async getSales() {
                await axios.post('/get_orders', {
                    ...
                    r.saleDetails.forEach(product => {
                        ...
                        this.cart1.push(cartProduct);
                    })

                    this.sales.previousSubTotal = this.cart1.reduce((prev, curr) => {
                        return prev + parseFloat(curr.total)
                    }, 0).toFixed(2);
