...
// Size Entry 
$route['size'] = 'Administrator/Page/add_size';
...
// product color
$route['get_product_color'] = 'Administrator/Products/getProductColor';
$route['get_product_size'] = 'Administrator/Products/getProductSize';
