                          ...
                          <table _a584de>
                              <thead>
                                  <tr>
                                      ...
                                      <td align="right"><strong>Total</strong></strong></td>
                                  </tr>
                              </thead>
                              <tbody>
                          ...
                          <div style="border:1px solid #000; margin-top:5px;padding:5px;overflow:hidden">
                              ...
                              <table style="width:50%;">
                                  <tr>
                                      ...
                                      <td style="text-align:right"><strong>{{ parseFloat(+parseFloat(sales.SaleMaster_cashPaid) + parseFloat(sales.ex_cash_amount)).toFixed(2)  }}</strong></td>
                                  </tr>
                                  <tr v-for="(item, index) in banks" v-if="banks.length > 0">
                                      <td><strong>{{item.bank_name}}:</strong></td>
                                      <td style="text-align:right"><strong>{{ parseFloat(+parseFloat(item.amount) + parseFloat(item.exchange_bank_amount)).toFixed(2)  }}</strong></td>
                                  </tr>
                      ...
                      <div class="col-xs-6">
                          <table _t92sadbc2>
                              <tr>
                                  ...
                                  <td style="text-align:right">{{ parseFloat(+parseFloat(sales.SaleMaster_SubTotalAmount) + parseFloat(sales.takeAmount) - parseFloat(sales.returnAmount)).toFixed(2) }}</td>
                              </tr>
                              ...
                              <tr>
                                  <td><strong>Total:</strong></td>
                                  <td style="text-align:right">{{ parseFloat(+parseFloat(sales.SaleMaster_TotalSaleAmount)  + parseFloat(sales.takeAmount) - parseFloat(sales.returnAmount)).toFixed(2) }}</td>
                              </tr>
                              <tr v-if='sales.SaleMaster_bankPaid > 0'>
                                    <td><strong>Bank/Bkash Charge(1.5%):</strong></td>
                                    <td style="text-align:right">{{ banks.reduce((acc, pre) => {return acc + +parseFloat(pre.charge_amount)},0).toFixed(2) }}</td>
                              </tr>
